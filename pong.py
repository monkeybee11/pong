...
#veriables for breadboard  connect (IC pin 1 to twisty knob 1 middle pin ) (IC pin 2 to twisty 2 knob middle pin) (pin1 of both twisty knobs ot 3.3v and Ω pin to GND)
